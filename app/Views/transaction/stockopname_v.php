                        ...
                        <div class="table-responsive m-t-40">
                            <table id="example23" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
                                ...
                                <tbody>
                                    ...
                                    if (!empty($from)) {
                                        $build->where("DATE(stockopname.stockopname_datetime) >=", $from);
                                    }

                                    if (!empty($to)) {
                                        $build->where("DATE(stockopname.stockopname_datetime) <=", $to);
                                    }
                                    $usr = $build->orderBy("product_name", "ASC")
                                        ->get();
                                    //echo $this->db->getLastquery();
                                    $no = 1;
